...
Nexotao retail rates are a **manual snapshot**, calculated as **75% of AWS
Bedrock US Standard on-demand pricing** and converted at **Rp 18,000/USD**. That
means 25% below that AWS reference at the time the catalog was set; it does not
mean rates automatically follow a single worldwide or "global" price.
