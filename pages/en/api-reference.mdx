...
| `POST` | `/v1/chat/completions` | OpenAI Chat Completions — all 34 models |
| `POST` | `/v1/responses` | OpenAI Responses — `gpt-5.6-terra` and `gpt-5.6-luna` |
| `POST` | `/v1/messages` | Anthropic Messages — the 32 Bedrock models |
